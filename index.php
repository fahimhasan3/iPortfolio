            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="icofont-rounded-right"></i> <strong>Degree:</strong> Secondary School Diploma in Computer Science and Telecomunications</li>
            ...
            <div class="resume-item">
              ...
              <div class='row'>
                <div class="col-lg-6">
                  ...
                  <ul>
                    <li>Analyze customers requests</li>
                    <li>Discuss solutions with manager and team</li>
                    <li>Develop software</li>
                    <li>Create code documentation</li>
                    <li>Test the software</li>
                    <li>Release in production</li>
                    <li>Crypting sensible patients information on the database.</li>
                  </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="resume-item">
              ...
              <div class='row'>
                <div class="col-lg-6">
                  <p><b>Responsibilities</b></p>
                  <ul>
                    <li>Developing new features in java and javascript under the direction of a senior developers</li>
                    <li>Test the software</li>
                    <li>Maintenance of production projects (bugs)</li>
                    <li>Creating reports using jasper reports</li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <p><b>Technologies</b></p>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap" onclick="location.href='company-directory-details.html';">
              <img src="assets/img/portfolio/company-directory.PNG" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="assets/img/portfolio/company-directory.PNG" data-gall="portfolioGallery" class="venobox"
                  title="App 2"><i class="bx bx-plus"></i></a>
                <a href="company-directory-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Witton, Birmingham, UK</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Email:</h4>
                <p>fahimgasan@gmail.com</p>
              </div>
